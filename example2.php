...
<html>
    ...
    <p>出来る事</p>
    <ul>
        <li>１）ログインユーザの投稿アルバム（写真）の一覧を取得</li>
        <li>２）ログインユーザの所属グループの一覧を取得</li>
        <li>その他参考になりそうなページ
        <ul>
        <li><a href="https://developers.facebook.com/docs/reference/api/">Facebookでユーザのどんな情報にアクセス出来るか一覧</a></li>
　      <li><a href="https://developers.facebook.com/docs/authentication/permissions/">Facebookでユーザの持っている情報へアクセスする時の許可リスト</a></li>
        </ul>
        </li>
    </ul>
_HEADER_;
